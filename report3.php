...
<table align=center>
	...
	from tb_members inner join tb_house on tb_members.serial_no=tb_house.serial_no inner join tb_meal on tb_members.serial_no=tb_meal.serial_no  where  tb_members.serial_no= '$bid'  ";
					 ...
					 ?>
						...
						<center><h1>Mess Management System </h1>
									...
									Contact NO:01511122200 
												...
												<td> <?php echo $total= $row['rate'] * $row['meal']; ;?></td>
